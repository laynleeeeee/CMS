...
<!--
	...
	Description: Monthly Summary of Withholding Taxes Expanded.
 -->
...
function searchMonthlySummary() {
	...
	if (isValidFilters) {
		$("#spanMonthError").text("");
		var url = contextPath + "/summaryWithholdingTaxes/generatePDF"+getCommonParam();
	}
	$('#reportMonthlySummary').attr('src',url);
	$('#reportMonthlySummary').load();
}
</script>
</head>
<body>
...
<div>
 <iframe id="reportMonthlySummary"></iframe>
</div>
<hr class="thin2">
</body>
</html>
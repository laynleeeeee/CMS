...
<!--
	...
	Description: Balance Sheet By Division Report main page.
 -->
...
function generateIncomeStatement() {
	...
	if(date ==  "") {
		isValidDate = true;
		$("#errorDate").text("Please enter valid date.");
	}
	var url = "";
	if(!isValidCompany && !isValidDate) {
		$("#errorCompany").text("");
		$("#errorDate").text("");
		url = contextPath + "/balanceSheetByDiv/generate"+getCommonParam();
	}
	$('#balanceSheetByDiv').attr('src',url);
	$('#balanceSheetByDiv').load();
}
...
function getCommonParam () {
	...
	return "?companyId="+companyId+(subDivision != undefined && subDivision != null ? "&subDivision="+subDivision : "")+"&accountLevelId="+accountLevelId
		+"&divisionId="+divisionId+"&date="+date+"&formatType="+formatType;
}
...
<table>
	...
	<tr>
		...
		<td class="tdDateFilter">
			<input type="text" id="date" maxlength="10" class="dateClass2"
				onblur="evalDate('date');">
	...
	<tr>
		<td class="title2"></td>
		<td class="value"><span id="spanDivisionError" class="error"></span></td>
	</tr>
...
<div>
	<iframe id="balanceSheetByDiv"></iframe>
</div>
</body>
</html>
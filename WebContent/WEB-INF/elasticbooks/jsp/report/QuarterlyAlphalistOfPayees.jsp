...
$(document).ready(function() {
	...
	function generatePCVReport() {
		...
		if (isValidFilters) {
			clearValues();
			if(formatType=="dat"){
				url = contextPath + "/quarterlyAlphaListOfPayees/generateDAT" + getCommonParam();
			} else {
				url = contextPath + "/quarterlyAlphaListOfPayees/generatePDF" + getCommonParam();
			}
		}
		$("#iFrame").attr('src', url);
		$("#iFrame").load();
...
<body>
	<table>
			...
			<tr>
				...
				<td><select id="month" class="frmSelectClass" style="width: 150px">

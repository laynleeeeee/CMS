...
<!-- 
	...
	Description: Account analysis search page with additional searching for description.
 -->
<html>
<head>
...
function getCommonParam () {
	...
	var description = processSearchName($.trim($("#txtDescription").val()));
	...
	if($.trim(dateFrom) == "" && $.trim(dateTo) == "") {
		...
		var uri =  "?companyId="+companyId+"&accountId="+accountId+"&divisionIdFrom="+divisionIdFrom
				+"&divisionIdTo="+divisionIdTo+"&description="+description+"&dateFrom="+dateFrom
...
<table>
	...
	<tr>
		...
		<td><input type="text" id="txtDescription" class="input"></td>
	</tr>
	<tr>

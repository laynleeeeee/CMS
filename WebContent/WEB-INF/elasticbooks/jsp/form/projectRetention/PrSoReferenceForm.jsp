...
<!-- 
	...
	Description	: Sales order reference form for Project Retention form
-->
<!DOCTYPE html>
<html>
<head>
...
function getCommonParam() {
	...
	return contextPath+"/projectRetention/getSoReferences?companyId="+companyId
			+"&divisionId="+divisionId+"&arCustomerId="+arCustomerId+"&arCustomerAcctId="+(arCustomerAcctId != null ? arCustomerAcctId : "")
			+"&soNumber="+soNumber+"&poNumber="+poNumber+"&dateFrom="+dateFrom+"&dateTo="+dateTo+"&statusId="+status;
}
	...
	<div>
		<table class="frmField_set">
			...
			<div id="divSORefTable">
				<%@ include file = "PrSoReferenceTable.jsp" %>
			</div>
		</fieldset>

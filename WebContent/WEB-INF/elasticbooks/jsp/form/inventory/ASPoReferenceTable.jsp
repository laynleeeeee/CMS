		...
		<tbody>
			...
			<tr>
				<td style="border-left: none;">
					...
					<input type="hidden" class="hdnCustomerId" value="${as.arCustomerId}">
					<input type="hidden" class="hdnCustomerAccountId" value="${as.arCustomerAccountId}">
				</td>
				<td><fmt:formatDate pattern="MM/dd/yyyy" value="${as.poDate}" /></td>
				<td>${as.poNumber}</td>

...
<!-- 
	...
	Description	: Sales order reference form for waybill form
-->
<!DOCTYPE html>
<html>
<head>
...
function getCommonParam() {
	...
	return contextPath+"/deliveryReceipt/getSOReferenceForms?companyId="+companyId
			+"&arCustomerId="+arCustomerId+"&arCustomerAcctId="+(arCustomerAcctId != null ? arCustomerAcctId : "")
			+"&soNumber="+soNumber+"&drTypeId="+drTypeId+"&status=2";
}
	...
	<div>
		<table class="frmField_set">
			...
			<div id="divSORefTable">
				<%@ include file = "WbSoReferenceTable.jsp" %>
			</div>
		</fieldset>

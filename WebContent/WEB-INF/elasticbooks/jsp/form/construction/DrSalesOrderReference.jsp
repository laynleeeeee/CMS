...
function getCommonParam() {
	...
	return contextPath+"/deliveryReceipt/getSaleOrderForms?companyId="+companyId
			+"&arCustomerId="+arCustomerId+"&arCustomerAcctId="+(arCustomerAcctId != null ? arCustomerAcctId : "")
			+"&soNumber="+soNumber+"&status="+status+"&drTypeId="+drTypeId+"&dateFrom="+dateFrom+"&dateTo="+dateTo
			+"&poNumber="+poNumber+"&divisionId="+divisionId;
}
	...
	<div>
		<table class="frmField_set">
			...
			<div id="divSORefTable">
				<%@ include file = "DrSalesOrderReferenceTbl.jsp" %>
			</div>
		</fieldset>

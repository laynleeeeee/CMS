...
<!-- 
	...
	Description	: Sub work order reference form for work order
-->
<!DOCTYPE html>
<html>
<head>
...
function getCommonParam() {
	...
	return contextPath+"/workOrder/getWorkOrderForms?companyId="+companyId
			+"&arCustomerId="+arCustomerId+"&arCustomerAcctId="+(arCustomerAcctId != null ? arCustomerAcctId : "")
			+"&woNumber="+woNumber+"&status=2";
}
	...
	<div>
		<table class="frmField_set">
			...
			<div id="divRefWOTable">
				<%@ include file = "SubWOReferenceTable.jsp" %>
			</div>
		</fieldset>

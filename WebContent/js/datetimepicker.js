...
/* How to Use in JSP
 * 
 * Use this command in your jsp file:
 * 
...
var MonthYearColor = "#000000"; //Font Color of Month and Year in Calendar header. "#cc0033" - orig
var WeekHeadColor = "#AAAAAA"; //var WeekHeadColor="#18861B";//Background Color in Week header. "#18861B" - orig
var SundayColor = "#CCCCCC"; //var SundayColor="#C0F64F";//Background color of Sunday. "#C0F64F" -orig
var SaturdayColor = "#CCCCCC"; //Background color of Saturday. "#C0F64F" -orig
var WeekDayColor = "#EEEEEE"; //Background color of weekdays. "#FFEDA6" - orig
...
var imageFilesPath = baseContextPath + "/images/";

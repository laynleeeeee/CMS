-- Description: mysql view for statement of accounts
...
CREATE VIEW V_STATEMENT_OF_ACCOUNT AS
	...
	SELECT AC.COMPANY_ID, C.NAME, AC.AR_CUSTOMER_ACCOUNT_ID, AC.AR_CUSTOMER_ID, 'AC' AS SOURCE, AC.AR_RECEIPT_ID AS ID,
		...
		AC.AMOUNT AS RECEIPT_AMOUNT, AC.CREATED_DATE, '' AS AR_LINE_ID, F.CURRENT_STATUS_ID, F.IS_COMPLETE, 1, 0 as TERM_DAYS
		FROM AR_RECEIPT AC

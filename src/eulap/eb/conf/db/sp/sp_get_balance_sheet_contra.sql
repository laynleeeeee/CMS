-- Description: Stored proceedure that will get the balance sheet per account.

Delimiter //
DROP procedure IF EXISTS GET_BALANCE_SHEET_CONTRA;//
CREATE procedure GET_BALANCE_SHEET_CONTRA (IN IN_COMPANY_ID INT, IN IN_ACCOUNT_ID INT, 

...
/**
 * The parser for GRVFC biometric.

 *
 */
public class GRVFCParser implements PayrollParser{
			...
			while (rowIterator.hasNext()) {
				...
				while (cellIterator.hasNext()) {
					...
					if (cell.getColumnIndex() == EMP_NAME_COL_INDEX) {
						...
						date = org.apache.poi.ss.usermodel.DateUtil.getJavaDate(Double.parseDouble(cellValue));
						SimpleDateFormat dateNewFormat = new SimpleDateFormat("MM/dd/yyyy HH:mm");
						String newFormattedDate = dateNewFormat.format(date);
						date = dateNewFormat.parse(newFormattedDate);
	...
	public static void main (String args[]) throws ParseException {
		File file = new File ("../CMS/src/eulap/eb/payroll/grvfc.xls");
		GRVFCParser parser = new GRVFCParser();
		SimpleDateFormat sdFormat = new SimpleDateFormat("MM/dd/yyyy");
		Date startDate;
		try {
			startDate = sdFormat.parse("07/01/2020");
			Date endDate = sdFormat.parse("07/09/2020");

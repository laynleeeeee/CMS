 ...
 */
@Service
public class RequisitionFormPlugin extends MultiFormPlugin {
	private static Logger logger = Logger.getLogger(RequisitionFormPlugin.class);
	@Autowired
	...
	public Page<FormApprovalDto> retrieveForms(int typeId, FormPluginParam param) {
		...
		Page<RequisitionForm> requisitionForms = requisitionFormDao.getRequisitionForms(searchParam, typeId, param.getStatuses(), false, param.getPageSetting());
		logger.info("Retrieved "+requisitionForms.getTotalRecords()+" Requisition forms.");

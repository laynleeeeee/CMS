 ...
 */
public class QAPDetailsD1DtoFinal implements AlphalistDetail{
	...
	public String convertDetailToCSV() {
		...
		return scheduleNumber+","+fTypeCode+","+tin+","+branchCode+","+dATRegName+","+dATLastName+","+dATFirstName+","+dATMiddleName+","+retrnPeriod
				+","+seqNum +","+atcCode+","+taxRate+","+incomePayment+","+actualAmtWthld;
	}
	...
	public String toString() {
		return "QAPDetailsD1DtoFinal [tin=" + tin + ", branchCode=" + branchCode + ", registeredName=" + registeredName
				+ ", lastName=" + lastName + ", firstName=" + firstName + ", middleName=" + middleName
				+ ", retrnPeriod=" + retrnPeriod + ", seqNum=" + seqNum + ", atcCode=" + atcCode + ", taxRate="
				+ taxRate + ", incomePayment=" + incomePayment + ", actualAmtWthld=" + actualAmtWthld + "]";
	}
}

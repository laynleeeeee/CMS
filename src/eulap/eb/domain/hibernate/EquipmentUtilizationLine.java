...
/**
 * Object repesentation for EQUIPMENT_UTILIZATION_LINE table.

 *
 */
@Entity
@Table(name="EQUIPMENT_UTILIZATION_LINE")
public class EquipmentUtilizationLine extends AROtherCharge {
	...
	@Column(name = "EQUIPMENT_UTILIZATION_LINE_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public String toString() {
		...
		builder.append("EquipmentUtilizationLine [deliveryReceiptId=").append(deliveryReceiptId).append(", discountValue=")

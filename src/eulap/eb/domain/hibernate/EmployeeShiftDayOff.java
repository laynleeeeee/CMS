...
/**
 * Class representation of EMPLOYEE_SHIFT_DAY_OFF table from the database.

 */
@Entity
@Table(name="EMPLOYEE_SHIFT_DAY_OFF")
public class EmployeeShiftDayOff extends BaseDomain{
	...
	@Column(name = "EMPLOYEE_SHIFT_DAY_OFF_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public String toString() {
		...
		builder.append("EmployeeShiftDayOff [employeeShiftId=").append(employeeShiftId).append(", dayOfTheWeek=")

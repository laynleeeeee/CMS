...
/**
 * Object repesentation for AR_INVOICE_TRUCKING_LINE table.

 *
 */
@Entity
@Table(name="AR_INVOICE_TRUCKING_LINE")
public class ArInvoiceTruckingLine extends AROtherCharge {
	...
	public static final int OBJECT_TYPE = 12023;

	@Id
	@Override
	@GeneratedValue(generator = "increment")
	@GenericGenerator(name = "increment", strategy = "increment")
	@Column(name = "AR_INVOICE_TRUCKING_LINE_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public String toString() {
		...
		builder.append("ArInvoiceTruckingLine [arInvoiceId=").append(arInvoiceId).append(", discountValue=")

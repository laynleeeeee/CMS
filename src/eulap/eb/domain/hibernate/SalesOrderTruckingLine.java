...
/**
 * Object repesentation for SALES_ORDER_TRUCKING_LINE table.

 *
 */
@Entity
@Table(name="SALES_ORDER_TRUCKING_LINE")
public class SalesOrderTruckingLine extends AROtherCharge {
	...
	/**
	 * Sales Order Item object type id: 12020
	 */
	public static final int OBJECT_TYPE = 12020;

	@Id
	@Override
	@GeneratedValue(generator = "increment")
	@GenericGenerator(name = "increment", strategy = "increment")
	@Column(name = "SALES_ORDER_TRUCKING_LINE_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}

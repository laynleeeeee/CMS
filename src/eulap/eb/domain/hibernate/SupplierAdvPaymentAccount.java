...
/**
 * Object representation class for SUPPLIER_ADV_PAYMENT_ACCOUNT
 * If AP invoice item will be moved to CMS, this will be merged to inventory account

 */

@Entity
@Table(name="SUPPLIER_ADV_PAYMENT_ACCOUNT")
public class SupplierAdvPaymentAccount extends BaseDomain {
	...
	@Column (name = "SUPPLIER_ADV_PAYMENT_ACCOUNT_ID", columnDefinition="int(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public String toString() {
		...
		builder.append("SupplierAdvPaymentAccount [companyId=").append(companyId).append(", divisionId=")
				.append(divisionId).append(", accountCombinationId=").append(accountCombinationId).append(", active=")

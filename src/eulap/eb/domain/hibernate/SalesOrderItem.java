...
/**
 * Object representation for SALES_ORDER_ITEM table.

 *
 */
@Entity
@Table(name="SALES_ORDER_ITEM")
public class SalesOrderItem extends BaseFormLine {
	@Expose
	 ...
	 */
	public static final int OBJECT_TYPE = 12004;

	/**
	 * Sales Quotation Item to Sales Order Item OR type id: 12002
	 */
	public static final int SOI_SQI_RELATIONSHIP = 12002;

	public enum FIELD {
		id, salesOrderId, itemId, discount, amount, ebObjectId
	}
	...
	@Column(name = "SALES_ORDER_ITEM_ID", columnDefinition="int(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public String toString() {
		...
		builder.append("SalesOrderItem [salesOrderId=").append(salesOrderId).append(", grossAmount=")

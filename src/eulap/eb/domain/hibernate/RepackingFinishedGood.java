...
/**
 * Object representation class for REPACKING_FINISHED_GOOD table

 */

@Entity
@Table(name = "REPACKING_FINISHED_GOOD")
public class RepackingFinishedGood extends BaseItem {
	...
	public static final int RP_FINISHED_GOOD_OBJ_TYPE_ID = 165;

	@Id
	@Override
	@GeneratedValue(generator = "increment")
	@GenericGenerator (name = "increment", strategy = "increment")
	@Column (name = "REPACKING_FINISHED_GOOD_ID", columnDefinition="int(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
	...
	public Integer getObjectTypeId() {
		return RP_FINISHED_GOOD_OBJ_TYPE_ID;
	}
	...
	public String toString() {
		...
		builder.append("RepackingFinishedGood [repackingId=").append(repackingId).append(", refenceObjectId=")

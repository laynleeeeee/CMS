...
/**
 * Object representation class for SALES_QUOTATION_LINE table

 */

@Entity
@Table(name="SALES_QUOTATION_LINE")
public class SalesQuotationLine extends AROtherCharge {
	...
	public static final int OBJECT_TYPE = 12002;

	@Id
	@Override
	@GeneratedValue(generator = "increment")
	@GenericGenerator(name = "increment", strategy = "increment")
	@Column(name = "SALES_QUOTATION_LINE_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}

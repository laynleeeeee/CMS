...
/**
 * A class that represents the INVOICE_CLASSIFICATION table in the database.

 *
 */
@Entity
@Table (name="INVOICE_CLASSIFICATION")
public class InvoiceClassification extends BaseDomain {
	...
	@Column(name = "INVOICE_CLASSIFICATION_ID", columnDefinition = "INT(10)", unique = true, nullable = false, insertable = false, updatable = false)
	public int getId() {
		return super.getId();
	}
